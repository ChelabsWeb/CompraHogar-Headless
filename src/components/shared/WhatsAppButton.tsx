        ...
        <div className="fixed bottom-5 right-5 z-[100] flex items-end gap-2">
            ...
            {isTooltipVisible && (
                <div className="relative bg-white rounded-lg shadow-lg border border-slate-100 px-3 py-2 mb-1 max-w-[180px] animate-in fade-in slide-in-from-right-2 duration-300">
                    ...
                    <div className="absolute bottom-2 right-[-6px] w-3 h-3 bg-white border-r border-b border-slate-100 rotate-[-45deg]" />
                </div>
            )}
            ...
            <a
                ...
                className="w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#20BD5A] shadow-lg hover:shadow-xl flex items-center justify-center transition-all duration-300 hover:scale-105"
            >
